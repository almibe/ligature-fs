...
[<Tests>]
let tests =
    testList "Binding Tests" [
        testCase "add a single value and read" <| fun _ ->
        ...
        testCase "test scoping" <| fun _ ->
            ...
            Expect.equal (read "hello" bindings) (Some(Integer(6))) "Read bindings after adding known value in new scope."
