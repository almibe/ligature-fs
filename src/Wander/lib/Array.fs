...
let distinctFunction<'t> = WanderValue.Function(Function.HostFunction (
...
let catFunction<'t> = WanderValue.Function(Function.HostFunction (
    new HostFunction((fun args bindings ->
        match args with
...
let insertFirstFunction<'t> = WanderValue.Function(Function.HostFunction (
    new HostFunction((fun args bindings ->
        match args with
...
let insertLastFunction<'t> = WanderValue.Function(Function.HostFunction (
    new HostFunction((fun args bindings ->
        match args with
...
let mapFunction<'t> = WanderValue.Function(Function.HostFunction (
    new HostFunction((fun args bindings ->
        match args with
...
let reduceFunction<'t> = WanderValue.Function(Function.HostFunction (
    new HostFunction((fun args bindings ->
        match args with
        | [WanderValue.Function(fn); WanderValue.Array(array)] ->
...
let foldFunction<'t> = WanderValue.Function(Function.HostFunction (
    new HostFunction((fun args bindings ->
        match args with
...
let arrayLib<'t> = WanderValue.Record (Map [
    ("cat", catFunction)
    ("map", mapFunction)
