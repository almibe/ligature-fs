...
let triplePatternNib (gaze: Gaze.Gaze<Token>) : Result<(TermPattern * TermPattern * ValuePattern), Gaze.GazeError> =
    let entity = elementPatternNib gaze
    let attribute = elementPatternNib gaze
    let value = valuePatternNib gaze
